 ...
 */
export declare type SortEvent<T, M> = (a: CalendarEvent<T, M>, b: CalendarEvent<T, M>) => number;
/**
...
export declare class Sorts {
     ...
     */
    static Start<T, M>(a: CalendarEvent<T, M>, b: CalendarEvent<T, M>): number;
    /**
     ...
     * @see [[CalendarEvent.time]]
     */
    static End<T, M>(a: CalendarEvent<T, M>, b: CalendarEvent<T, M>): number;
    /**
     ...
     */
    static FullDay<T, M>(a: CalendarEvent<T, M>, b: CalendarEvent<T, M>): number;
    /**
     ...
     * @see [[DaySpan.millis]]
     */
    static Duration<T, M>(a: CalendarEvent<T, M>, b: CalendarEvent<T, M>): number;
    /**
     ...
     */
    static Desc<T, M>(sorter: SortEvent<T, M>): SortEvent<T, M>;
    /**
     ...
     */
    static Alphabetical<T, M>(getString: (event: Event<T, M>) => string): SortEvent<T, M>;
    /**
     ...
     */
    static Ordered<T, M>(getOrder: (event: Event<T, M>) => number): SortEvent<T, M>;
    /**
     ...
     */
    static List<T, M>(sorters: SortEvent<T, M>[]): SortEvent<T, M>;
}
